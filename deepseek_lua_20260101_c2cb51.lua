...
FunctionFontColor = Color3.fromRGB(255, 255, 255)  -- 改为白色，在图片上更清晰
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(20, 20, 20)
      ...
      DropShadow.Image = "rbxassetid://123793012232435"  -- 修改后的背景图片ID
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://70469295824259"  -- 修改后的隐藏UI按钮图片ID
Open.MouseButton1Click:Connect(function()
  playClickSound()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://70469295824259" or "rbxassetid://70469295824259"  -- 统一使用同一个图片ID
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabText.Text = name
        TabText.TextColor3 = TabFontColor  -- 使用标签页字体颜色（白色）
...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionText.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
          ...
          function section.Button(section, text, callback)
            ...
            local BtnImage = Instance.new("ImageLabel")  -- 添加图片
            ...
            Btn.BackgroundColor3 = Color3.fromRGB(255,255,255)  -- 改为白色背景
            Btn.BorderSizePixel = 0
            Btn.Size = UDim2.new(0, 428, 0, 38)
            Btn.AutoButtonColor = false
            Btn.Font = Enum.Font.GothamSemibold
            Btn.Text = "   " .. text
            Btn.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            Btn.TextSize = 16.000
            Btn.TextXAlignment = Enum.TextXAlignment.Left
            Btn.BackgroundTransparency = 1  -- 完全透明，只显示图片
            ...
            BtnImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
            BtnImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
            BtnImage.ImageTransparency = 0  -- 完全显示图片

            -- 按钮悬停动画
            Btn.MouseEnter:Connect(function()
                Tween(BtnImage, {0.2, 'Quad', 'Out'}, {
        ...
        function section:Label(text)
          ...
          local LabelImage = Instance.new("ImageLabel")  -- 添加图片
          ...
          TextLabel.Text = text
          TextLabel.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
          TextLabel.BackgroundTransparency = 1  -- 完全透明
          ...
          LabelImage.Parent = TextLabel
          LabelImage.BackgroundTransparency = 1
          LabelImage.Size = UDim2.new(1, 0, 1, 0)
          LabelImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
          LabelImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
          LabelImage.ImageTransparency = 0  -- 完全显示图片
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            local ToggleImage = Instance.new("ImageLabel")  -- 添加图片
            ...
            ToggleBtn.BackgroundTransparency = 1  -- 完全透明
            ToggleBtn.BorderSizePixel = 0
            ToggleBtn.Size = UDim2.new(0, 428, 0, 38)
            ToggleBtn.AutoButtonColor = false
            ToggleBtn.Font = Enum.Font.GothamSemibold
            ToggleBtn.Text = "   " .. text
            ToggleBtn.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            ...
            ToggleImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
            ToggleImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
            ToggleImage.ImageTransparency = 0  -- 完全显示图片
            
            -- 修复Toggle开关位置 - 在按钮内部，而不是飞出
            ...
            ToggleBtn.MouseEnter:Connect(function()
                Tween(ToggleImage, {0.2, 'Quad', 'Out'}, {
                    ImageTransparency = 0.1
                })
            end)
  ...
  local KeybindImage = Instance.new("ImageLabel")  -- 添加图片
  ...
  KeybindBtn.BackgroundTransparency = 1  -- 完全透明
  KeybindBtn.BorderSizePixel = 0
  KeybindBtn.Size = UDim2.new(0, 428, 0, 38)
  KeybindBtn.AutoButtonColor = false
  KeybindBtn.Font = Enum.Font.GothamSemibold
  KeybindBtn.Text = "   " .. text
  KeybindBtn.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
  ...
  KeybindImage.Parent = KeybindBtn
  KeybindImage.BackgroundTransparency = 1
  KeybindImage.Size = UDim2.new(1, 0, 1, 0)
  KeybindImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
  KeybindImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
  KeybindImage.ImageTransparency = 0  -- 完全显示图片
  ...
  KeybindValue.Position = UDim2.new(0.75, 0, 0.2, 0)  -- 调整位置
  ...
  KeybindBtn.MouseEnter:Connect(function()
      Tween(KeybindImage, {0.2, 'Quad', 'Out'}, {
          ImageTransparency = 0.1
      })
  end)
...
function section.Textbox(section, text, flag, default, callback)
  ...
  local TextboxImage = Instance.new("ImageLabel")  -- 添加图片
  ...
  TextboxBack.BackgroundTransparency = 1  -- 完全透明
  TextboxBack.BorderSizePixel = 0
  TextboxBack.Size = UDim2.new(0, 428, 0, 38)
  TextboxBack.AutoButtonColor = false
  TextboxBack.Font = Enum.Font.GothamSemibold
  TextboxBack.Text = "   " .. text
  TextboxBack.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
  ...
  TextboxImage.Parent = TextboxBack
  TextboxImage.BackgroundTransparency = 1
  TextboxImage.Size = UDim2.new(1, 0, 1, 0)
  TextboxImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
  TextboxImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
  TextboxImage.ImageTransparency = 0  -- 完全显示图片
  ...
  BoxBG.Position = UDim2.new(0.75, 0, 0.2, 0)  -- 调整位置
  ...
  TextboxBack.MouseEnter:Connect(function()
      Tween(TextboxImage, {0.2, 'Quad', 'Out'}, {
          ImageTransparency = 0.1
      })
  end)
  ...
  BoxBG.Size = UDim2.new(0, TextBox.TextBounds.X + 30, 0, 28)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            local SliderImage = Instance.new("ImageLabel")  -- 添加图片
            ...
            SliderBack.BackgroundTransparency = 1  -- 完全透明
            SliderBack.BorderSizePixel = 0
            SliderBack.Size = UDim2.new(0, 428, 0, 38)
            SliderBack.AutoButtonColor = false
            SliderBack.Font = Enum.Font.GothamSemibold
            SliderBack.Text = "   " .. text
            SliderBack.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            ...
            SliderImage.Parent = SliderBack
            SliderImage.BackgroundTransparency = 1
            SliderImage.Size = UDim2.new(1, 0, 1, 0)
            SliderImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
            SliderImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
            SliderImage.ImageTransparency = 0  -- 完全显示图片
            ...
            SliderBar.Position = UDim2.new(0.3, 0, 0.5, 0)  -- 调整位置
            SliderBar.Size = UDim2.new(0, 140, 0, 12)
            SliderBar.ZIndex = 10  -- 提高层级
            ...
            SliderValBG.Position = UDim2.new(0.8, 0, 0.2, 0)  -- 调整位置
            ...
            MinSlider.Position = UDim2.new(0.25, 0, 0.2, 0)  -- 调整位置
            MinSlider.Size = UDim2.new(0, 20, 0, 20)
            MinSlider.Font = Enum.Font.Gotham
            MinSlider.Text = "-"
            MinSlider.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            MinSlider.TextSize = 24.000
            MinSlider.TextWrapped = true
            MinSlider.ZIndex = 10  -- 提高层级
            ...
            AddSlider.Position = UDim2.new(0.73, 0, 0.5, 0)  -- 调整位置
            AddSlider.Size = UDim2.new(0, 20, 0, 20)
            AddSlider.Font = Enum.Font.Gotham
            AddSlider.Text = "+"
            AddSlider.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            AddSlider.TextSize = 24.000
            AddSlider.TextWrapped = true
            AddSlider.ZIndex = 10  -- 提高层级
            ...
            SliderBack.MouseEnter:Connect(function()
                Tween(SliderImage, {0.2, 'Quad', 'Out'}, {
                    ImageTransparency = 0.1
                })
            end)
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            local DropdownImage = Instance.new("ImageLabel")  -- 添加图片
            ...
            DropdownTop.BackgroundTransparency = 1  -- 完全透明
            DropdownTop.BorderSizePixel = 0
            DropdownTop.Size = UDim2.new(0, 428, 0, 38)
            DropdownTop.AutoButtonColor = false
            DropdownTop.Font = Enum.Font.GothamSemibold
            DropdownTop.Text = ""
            DropdownTop.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            ...
            DropdownImage.Parent = DropdownTop
            DropdownImage.BackgroundTransparency = 1
            DropdownImage.Size = UDim2.new(1, 0, 1, 0)
            DropdownImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
            DropdownImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
            DropdownImage.ImageTransparency = 0  -- 完全显示图片
            ...
            DropdownOpen.Position = UDim2.new(0.9, 0, 0.5, 0)  -- 调整位置
            DropdownOpen.Size = UDim2.new(0, 20, 0, 20)
            DropdownOpen.Font = Enum.Font.Gotham
            DropdownOpen.Text = "+"
            DropdownOpen.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            DropdownOpen.TextSize = 24.000
            DropdownOpen.TextWrapped = true
            DropdownOpen.ZIndex = 10  -- 提高层级
            ...
            DropdownText.Position = UDim2.new(0.05, 0, 0, 0)  -- 调整位置
            DropdownText.Size = UDim2.new(0, 184, 0, 38)
            DropdownText.Font = Enum.Font.GothamSemibold
            DropdownText.PlaceholderColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            DropdownText.PlaceholderText = text
            DropdownText.Text = ""
            DropdownText.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
            DropdownText.TextSize = 16.000
            DropdownText.TextXAlignment = Enum.TextXAlignment.Left
            DropdownText.ZIndex = 10  -- 提高层级
            ...
            DropdownTop.MouseEnter:Connect(function()
                Tween(DropdownImage, {0.2, 'Quad', 'Out'}, {
                    ImageTransparency = 0.1
                })
            end)
            ...
            funcs.AddOption = function(self, option)
              local Option = Instance.new("TextButton")
              local OptionC = Instance.new("UICorner")     
              local OptionImage = Instance.new("ImageLabel")  -- 添加图片
    
              Option.Name = "Option_" .. option
              Option.Parent = DropdownModule
              Option.BackgroundColor3 = Color3.fromRGB(255,255,255)
              Option.BackgroundTransparency = 1  -- 完全透明
              ...
              Option.Text = option
              Option.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（白色）
              Option.TextSize = 14.000
              Option.ZIndex = 10  -- 提高层级
              ...
              -- 添加选项按钮图片
              OptionImage.Name = "OptionImage"
              OptionImage.Parent = Option
              OptionImage.BackgroundTransparency = 1
              OptionImage.Size = UDim2.new(1, 0, 1, 0)
              OptionImage.Image = "rbxassetid://138411013997131"  -- 功能按钮图片ID
              OptionImage.ScaleType = Enum.ScaleType.Stretch  -- 改为拉伸模式
              OptionImage.ImageTransparency = 0  -- 完全显示图片
              OptionImage.ZIndex = 9  -- 层级略低于文字
              
              -- 选项悬停动画
              Option.MouseEnter:Connect(function()
                  Tween(OptionImage, {0.2, 'Quad', 'Out'}, {
                      ImageTransparency = 0.1
                  })
              end)
