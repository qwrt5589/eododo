...
-- 霓虹灯颜色函数
function createNeonGradient(parent)
    local neonGradient = Instance.new("UIGradient")
    neonGradient.Parent = parent
    ...
    neonGradient.Color = ColorSequence.new{
        ...
        ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 0, 255))    -- 紫色
    }
    local tween = TweenService:Create(neonGradient, TweenInfo.new(2, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, -1), {Offset = Vector2.new(1, 0)})
    tween:Play()
    return neonGradient
end
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(20, 20, 20)
      ...
      ScriptTitle.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
      ...
      createNeonGradient(ScriptTitle)
...
UIG.Parent = Open
  ...
  function section.Button(section, text, callback)
    ...
    Btn.Text = "   " .. text
    Btn.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
    Btn.TextSize = 16.000
    Btn.TextXAlignment = Enum.TextXAlignment.Left
    Btn.BackgroundTransparency = ALTransparency
    
    -- 为按钮文字添加霓虹灯渐变效果
    createNeonGradient(Btn)
...
function section:Label(text)
  ...
  function section.Toggle(section, text, flag, enabled, callback)
    ...
    ToggleBtn.Text = "   " .. text
    ToggleBtn.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
    ToggleBtn.TextSize = 16.000
    ToggleBtn.TextXAlignment = Enum.TextXAlignment.Left
    
    -- 为Toggle文字添加霓虹灯渐变效果
    createNeonGradient(ToggleBtn)
  ...
  TabText.Text = name
  TabText.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
  TabText.TextSize = 14.000
  TabText.TextXAlignment = Enum.TextXAlignment.Left
  TabText.TextTransparency = 0.2
  
  -- 为Tab文字添加霓虹灯渐变效果
  createNeonGradient(TabText)
  ...
  function tab.section(tab, name, TabVal)
    ...
    SectionText.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
    SectionText.TextSize = 16.000
    SectionText.TextXAlignment = Enum.TextXAlignment.Left
    
    -- 为Section标题添加霓虹灯渐变效果
    createNeonGradient(SectionText)
  ...
  KeybindBtn.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
  KeybindBtn.TextSize = 16.000
  KeybindBtn.TextXAlignment = Enum.TextXAlignment.Left
  KeybindBtn.BackgroundTransparency = ALTransparency
  
  -- 为Keybind文字添加霓虹灯渐变效果
  createNeonGradient(KeybindBtn)
  ...
  KeybindValue.TextColor3 = Color3.fromRGB(255, 255, 255) -- 白色文字
  KeybindValue.TextSize = 14.000
  
  -- 为Keybind值文字添加霓虹灯渐变效果
  createNeonGradient(KeybindValue)
