...
-- ========== 全局颜色个主题 ==========
local TextColor = Color3.fromRGB(255, 255, 255)  -- 亮白色文本
local PlaceholderColor = Color3.fromRGB(180, 180, 180)  -- 占位符颜色
local DisabledTextColor = Color3.fromRGB(150, 150, 150)  -- 禁用状态文本

-- 添加背景图片ID
local BackgroundImageId = "77167983693857"
...
function library.new(library, name, theme)
	...
	-- ========== 统一使用半透明黑色主题 ==========
	local MainColor = Color3.fromRGB(0, 0, 0)       -- 黑色主色调
	local Background = Color3.fromRGB(0, 0, 0)      -- 黑色背景
	local BackgroundTransparency = 0.5              -- 半透明效果
	local zyColor = Color3.fromRGB(30, 30, 30)      -- 深灰色控件背景
	local zyColorTransparency = 0.6                 -- 控件半透明
	local beijingColor = Color3.fromRGB(255, 255, 255) -- 亮白色元素

	local dogent = Instance.new("ScreenGui")
	local Main = Instance.new("Frame")
	local BackgroundImage = Instance.new("ImageLabel") -- 添加背景图片
	...
	BackgroundImage.ScaleType = Enum.ScaleType.Crop  -- 裁剪以完全填充
	BackgroundImage.TileSize = UDim2.new(0, 572, 0, 353)  -- 设置平铺尺寸
	...
	BackgroundOverlay.BackgroundTransparency = 0.9  -- 半透明黑色遮罩
	...
	-- ========== 右侧白色导航线（扩大点击区域版本） ==========
	NavLine.Name = "NavLine"
	NavLine.Parent = dogent
	NavLine.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	NavLine.BackgroundTransparency = 0.7
	NavLine.BorderSizePixel = 0
	NavLine.Position = UDim2.new(1, -10, 0.5, 0)  -- 右侧中间位置
	NavLine.AnchorPoint = Vector2.new(1, 0.5)
	NavLine.Size = UDim2.new(0, 4, 0, 120)  -- 纤细的导航线（视觉大小不变）
	NavLine.ZIndex = 100
	
	-- 导航线圆角
	local NavLineCorner = Instance.new("UICorner")
	NavLineCorner.CornerRadius = UDim.new(0, 2)
	NavLineCorner.Parent = NavLine
	
	-- ========== 扩大点击区域的外框 ==========
	local NavHitbox = Instance.new("Frame")
	NavHitbox.Name = "NavHitbox"
	NavHitbox.Parent = NavLine
	NavHitbox.BackgroundTransparency = 1  -- 完全透明
	NavHitbox.BorderSizePixel = 0
	NavHitbox.Position = UDim2.new(-1, 0, -0.5, 0)  -- 向外扩展
	NavHitbox.Size = UDim2.new(3, 0, 2, 0)  -- 3倍宽，2倍高，点击区域扩大
	NavHitbox.ZIndex = 101
	
	-- 导航按钮（覆盖扩大的点击区域，用于点击）
	NavButton.Name = "NavButton"
	NavButton.Parent = NavHitbox  -- 现在放在扩大区域上
	NavButton.BackgroundTransparency = 1
	NavButton.Size = UDim2.new(1, 0, 1, 0)
	NavButton.ZIndex = 102
	
	-- ========== 右上角关闭按钮 ==========
	CloseButton.Name = "CloseButton"
	CloseButton.Parent = Main
	CloseButton.BackgroundColor3 = Color3.fromRGB(255, 50, 50)  -- 红色背景
	CloseButton.BorderColor3 = Color3.fromRGB(150, 0, 0)  -- 深红色边框
	CloseButton.BorderSizePixel = 2
	CloseButton.Position = UDim2.new(1, -10, 0, 10)  -- 右上角位置
	CloseButton.Size = UDim2.new(0, 30, 0, 30)  -- 小正方形按钮
	...
	ConfirmPanel.Parent = Main  -- 现在放在主UI内
	ConfirmPanel.BackgroundColor3 = Color3.fromRGB(200, 50, 50)  -- 红色背景
	ConfirmPanel.BackgroundTransparency = 0.9  -- 初始完全透明
	ConfirmPanel.BorderSizePixel = 0
	ConfirmPanel.Size = UDim2.new(0, 250, 0, 180)  -- 中等大小
	ConfirmPanel.Position = UDim2.new(0.5, 0, 0.5, 0)
	ConfirmPanel.AnchorPoint = Vector2.new(0.5, 0.5)
	ConfirmPanel.ZIndex = 150
	ConfirmPanel.Visible = false
	
	-- 面板圆角
	local PanelCorner = Instance.new("UICorner")
	PanelCorner.CornerRadius = UDim.new(0, 15)
	PanelCorner.Parent = ConfirmPanel
	
	-- 面板阴影
	local PanelShadow = Instance.new("ImageLabel")
	PanelShadow.Name = "PanelShadow"
	PanelShadow.Parent = ConfirmPanel
	...
	PanelShadow.ImageColor3 = Color3.fromRGB(150, 0, 0)
	PanelShadow.ImageTransparency = 0.7
	PanelShadow.ScaleType = Enum.ScaleType.Slice
	PanelShadow.SliceCenter = Rect.new(50, 50, 50, 50)
	PanelShadow.ZIndex = 149
	
	-- 面板标题
	local PanelTitle = Instance.new("TextLabel")
	PanelTitle.Name = "PanelTitle"
	PanelTitle.Parent = ConfirmPanel
	PanelTitle.BackgroundTransparency = 1
	PanelTitle.Size = UDim2.new(1, 0, 0, 50)
	PanelTitle.Position = UDim2.new(0, 0, 0, 10)
	PanelTitle.Font = Enum.Font.GothamBlack
	PanelTitle.Text = "是否关闭此UI？"
	PanelTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
	PanelTitle.TextSize = 20
	PanelTitle.TextTransparency = 0
	PanelTitle.ZIndex = 151
	
	-- 确定按钮（上面）
	local ConfirmButton = Instance.new("TextButton")
	ConfirmButton.Name = "ConfirmButton"
	ConfirmButton.Parent = ConfirmPanel
	ConfirmButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- 白色背景
	ConfirmButton.BorderColor3 = Color3.fromRGB(100, 100, 100)  -- 灰色边框
	ConfirmButton.BorderSizePixel = 2
	ConfirmButton.Size = UDim2.new(0.8, 0, 0, 40)
	ConfirmButton.Position = UDim2.new(0.1, 0, 0.3, 0)
	ConfirmButton.Font = Enum.Font.GothamBold
	ConfirmButton.Text = "确定"
	ConfirmButton.TextColor3 = Color3.fromRGB(0, 0, 0)  -- 黑色文字
	ConfirmButton.TextSize = 16
	ConfirmButton.ZIndex = 151
	...
	CancelButton.BackgroundColor3 = Color3.fromRGB(255, 50, 50)  -- 红色背景
	CancelButton.BorderColor3 = Color3.fromRGB(150, 0, 0)  -- 深红色边框
	...
	CancelButton.TextColor3 = Color3.fromRGB(0, 0, 0)  -- 黑色文字
	CancelButton.TextSize = 16
	CancelButton.ZIndex = 151
	...
	CancelButton.MouseButton1Click:Connect(function()
		-- 关闭确认面板的动画
		TweenService:Create(ConfirmPanel, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		task.wait(0.3)
		ConfirmPanel.Visible = false
		ConfirmPanel.Size = UDim2.new(0, 250, 0, 180)  -- 恢复原始大小
	end)
	...
	CloseButton.MouseButton1Click:Connect(function()
		...
		ConfirmPanel.BackgroundTransparency = 0.9
		ConfirmPanel.Size = UDim2.new(0, 0, 0, 0)
		
		-- 面板出现动画
		TweenService:Create(ConfirmPanel, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
		...
		task.spawn(function()
			...
			if ConfirmPanel.Visible then
				...
				task.wait(0.3)
				ConfirmPanel.Visible = false
				ConfirmPanel.Size = UDim2.new(0, 250, 0, 180)
			end
		end)
	end)
	
	-- ========== 导航线点击逻辑（简化版，只负责打开/关闭主UI） ==========
	local isMainOpen = false
	
	NavButton.MouseButton1Click:Connect(function()
		-- 悬停效果
		TweenService:Create(NavLine, TweenInfo.new(0.15), {
			Size = UDim2.new(0, 6, 0, 140),
			BackgroundTransparency = 0.2,
			BackgroundColor3 = Color3.fromRGB(220, 220, 255)
		}):Play()
		
		-- 打开主界面
		if not isMainOpen then
			Main.Visible = true
			isMainOpen = true
		else
			Main.Visible = false
	...
	game:GetService("RunService").RenderStepped:Connect(function()
		-- 确保导航线保持在屏幕右侧
		local screenSize = services.Players.LocalPlayer:WaitForChild("PlayerGui").AbsoluteSize
		local navSize = NavLine.AbsoluteSize
		local navPos = NavLine.AbsolutePosition
		
		-- 如果导航线被拖出屏幕，自动调整位置
		if navPos.x > screenSize.x - 5 then
			NavLine.Position = UDim2.new(1, -10, NavLine.Position.Y.Scale, NavLine.Position.Y.Offset)
		elseif navPos.x < screenSize.x - 100 then
			NavLine.Position = UDim2.new(1, -10, NavLine.Position.Y.Scale, NavLine.Position.Y.Offset)
		end
		
		-- 确保导航线垂直居中
		if navPos.y < 10 then
			NavLine.Position = UDim2.new(NavLine.Position.X.Scale, NavLine.Position.X.Offset, 0, 10)
		elseif navPos.y + navSize.y > screenSize.y - 10 then
			NavLine.Position = UDim2.new(NavLine.Position.X.Scale, NavLine.Position.X.Offset, 0, screenSize.y - navSize.y - 10)
		end
	end)
