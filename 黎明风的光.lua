...
function Ripple(obj)
    spawn(function()
        ...
        Ripple.ZIndex = 8
        Ripple.Image = "rbxassetid://128437395815901"
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://128437395815901"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://103224015043469" or "rbxassetid://91545768718105" --开关的图
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabIco.Image = "rbxassetid://111477850857548" or icon and "rbxassetid://"..icon
...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionOpen.Image = "rbxassetid://111477850857548"
          ...
          SectionOpened.Image = "rbxassetid://128437395815901"
