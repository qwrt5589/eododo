...
-- 修改预设颜色为淡蓝色
local PresetColor = Color3.fromRGB(173, 216, 230)  -- 浅蓝色
local ButtonColor = Color3.fromRGB(135, 206, 235)  -- 更蓝一点的淡蓝色（按钮颜色）
...
function lib:Window(text, preset, closebind)
    ...
    PresetColor = preset or Color3.fromRGB(173, 216, 230)  -- 默认淡蓝色
    ButtonColor = Color3.fromRGB(135, 206, 235)  -- 按钮蓝色
    fs = false
    ...
    Main.BackgroundColor3 = Color3.fromRGB(240, 248, 255)  -- 淡蓝色背景
    ...
    Title.Text = text
    Title.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        NotificationFrame.BackgroundColor3 = Color3.fromRGB(240, 248, 255)  -- 淡蓝色
        ...
        OkayBtn.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
        ...
        -- 胶囊型圆角：高度的一半
        OkayBtnCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
        ...
        OkayBtnTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        ...
        NotificationTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        ...
        NotificationDesc.TextColor3 = Color3.fromRGB(65, 105, 225)  -- 中蓝色文字
        ...
        OkayBtn.MouseEnter:Connect(
            function()
                TweenService:Create(
                    OkayBtn,
                    TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    {BackgroundColor3 = Color3.fromRGB(176, 224, 230)}  -- 更浅的蓝色悬停
                ):Play()
            end
        )
...
function tabhold:Tab(text)
    ...
    TabBtn.BackgroundColor3 = Color3.fromRGB(220, 230, 255)  -- 浅蓝色背景
    TabBtn.BackgroundTransparency = 0.3
    TabBtn.Size = UDim2.new(0, 107, 0, 32)  -- 增加高度以适应胶囊型
    ...
    -- TabBtn胶囊型圆角：高度的一半
    TabBtnCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    TabTitle.Text = text
    TabTitle.TextColor3 = Color3.fromRGB(70, 130, 180)  -- 钢蓝色文字
    TabTitle.TextSize = 14.000
    TabTitle.TextXAlignment = Enum.TextXAlignment.Left

    TabBtnIndicator.Name = "TabBtnIndicator"
    TabBtnIndicator.Parent = TabBtn
    TabBtnIndicator.BackgroundColor3 = PresetColor  -- 使用预设淡蓝色
    ...
    TabBtnIndicatorCorner.CornerRadius = UDim.new(0, 1)
    ...
    Tab.Active = true
    Tab.BackgroundColor3 = Color3.fromRGB(245, 250, 255)  -- 非常浅的蓝色背景
    ...
    Tab.ScrollBarImageColor3 = Color3.fromRGB(135, 206, 235)  -- 按钮蓝色滚动条
    Tab.Visible = false
    ...
    if fs == false then
        ...
        TabTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 选中时深蓝色
        Tab.Visible = true
    end
            ...
            for i, v in next, TabHold:GetChildren() do
                if v.Name == "TabBtn" then
                    ...
                    TweenService:Create(
                        v.TabTitle,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(70, 130, 180)}  -- 未选中时钢蓝色
                    ):Play()
                    TweenService:Create(
                        TabTitle,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {TextColor3 = Color3.fromRGB(25, 25, 112)}  -- 选中时深蓝色
                    ):Play()
                end
            end
        end
    ...
    function tabcontent:Button(text, callback)
        ...
        Button.Name = "Button"
        Button.Parent = Tab
        Button.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
        ...
        -- 胶囊型圆角：高度的一半
        ButtonCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
        ...
        ButtonTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    function tabcontent:Toggle(text, default, callback)
        ...
        Toggle.Name = "Toggle"
        Toggle.Parent = Tab
        Toggle.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
        ...
        -- 胶囊型圆角：高度的一半
        ToggleCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
        ...
        ToggleTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        ToggleTitle.TextSize = 14.000
        ToggleTitle.TextXAlignment = Enum.TextXAlignment.Left

        FrameToggle1.Name = "FrameToggle1"
        FrameToggle1.Parent = Toggle
        FrameToggle1.BackgroundColor3 = Color3.fromRGB(100, 149, 237)  -- 中蓝色
        FrameToggle1.Position = UDim2.new(0.86, 0, 0.286, 0)
        FrameToggle1.Size = UDim2.new(0, 37, 0, 18)
        
        FrameToggle1Corner.CornerRadius = UDim.new(1, 0)  -- 圆形
        ...
        FrameToggle2.BackgroundColor3 = ButtonColor  -- 按钮蓝色
        FrameToggle2.Position = UDim2.new(0.049, 0, 0.093, 0)
        FrameToggle2.Size = UDim2.new(0, 33, 0, 14)
        
        FrameToggle2Corner.CornerRadius = UDim.new(1, 0)  -- 圆形
        ...
        FrameToggle3.BackgroundColor3 = PresetColor  -- 淡蓝色
        FrameToggle3.BackgroundTransparency = 1.000
        FrameToggle3.Size = UDim2.new(0, 37, 0, 18)
        
        FrameToggle3Corner.CornerRadius = UDim.new(1, 0)  -- 圆形
        ...
        FrameToggleCircle.BackgroundColor3 = Color3.fromRGB(240, 248, 255)  -- 淡蓝色
        FrameToggleCircle.Position = UDim2.new(0.127, 0, 0.222, 0)
        FrameToggleCircle.Size = UDim2.new(0, 10, 0, 10)
        
        FrameToggleCircleCorner.CornerRadius = UDim.new(1, 0)  -- 圆形
            ...
            function()
                if toggled == false then
                    TweenService:Create(
                        Toggle,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {BackgroundColor3 = Color3.fromRGB(176, 224, 230)}  -- 更浅的蓝色
                    ):Play()
                    TweenService:Create(
                        FrameToggle1,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    ...
                    TweenService:Create(
                        FrameToggleCircle,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {BackgroundColor3 = Color3.fromRGB(255, 255, 255)}  -- 白色
                    ):Play()
                    FrameToggleCircle:TweenPosition(
                        UDim2.new(0.587, 0, 0.222, 0),
                        Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart,
                        .2,
                        true
                    ...
                    TweenService:Create(
                        FrameToggleCircle,
                        TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {BackgroundColor3 = Color3.fromRGB(240, 248, 255)}  -- 淡蓝色
                    ):Play()
                    FrameToggleCircle:TweenPosition(
                        UDim2.new(0.127, 0, 0.222, 0),
                        Enum.EasingDirection.Out,
                        Enum.EasingStyle.Quart,
                        .2,
                        true
        ...
        if default == true then
            TweenService:Create(
                Toggle,
                TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                {BackgroundColor3 = Color3.fromRGB(176, 224, 230)}
            ):Play()
            TweenService:Create(
                FrameToggle1,
                TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
    ...
    Slider.Name = "Slider"
    Slider.Parent = Tab
    Slider.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
    ...
    -- 胶囊型圆角：高度的一半（60/2=30）
    SliderCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    SliderTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    SliderValue.TextColor3 = Color3.fromRGB(70, 130, 180)  -- 钢蓝色文字
    SliderValue.TextSize = 14.000
    SliderValue.TextXAlignment = Enum.TextXAlignment.Right

    SlideFrame.Name = "SlideFrame"
    SlideFrame.Parent = Slider
    SlideFrame.BackgroundColor3 = Color3.fromRGB(173, 216, 230)  -- 浅蓝色
    SlideFrame.BorderSizePixel = 0
    SlideFrame.Position = UDim2.new(0.0342647657, 0, 0.686091602, 0)
    SlideFrame.Size = UDim2.new(0, 335, 0, 3)
    
    SlideFrameCorner.CornerRadius = UDim.new(1, 0)  -- 圆形
    SlideFrameCorner.Parent = SlideFrame

    CurrentValueFrame.Name = "CurrentValueFrame"
    CurrentValueFrame.Parent = SlideFrame
    CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(65, 105, 225)  -- 中蓝色进度条
    CurrentValueFrame.BorderSizePixel = 0
    CurrentValueFrame.Size = UDim2.new((start or 0) / max, 0, 0, 3)
    
    CurrentValueFrameCorner.CornerRadius = UDim.new(1, 0)  -- 圆形
    CurrentValueFrameCorner.Parent = CurrentValueFrame

    SlideCircle.Name = "SlideCircle"
    SlideCircle.Parent = SlideFrame
    SlideCircle.BackgroundColor3 = Color3.fromRGB(65, 105, 225)  -- 中蓝色
    SlideCircle.BackgroundTransparency = 1.000
    SlideCircle.Position = UDim2.new((start or 0) / max, -6, -1.30499995, 0)
    SlideCircle.Size = UDim2.new(0, 11, 0, 11)
    SlideCircle.Image = "rbxassetid://3570695787"
    SlideCircle.ImageColor3 = Color3.fromRGB(65, 105, 225)  -- 中蓝色

    coroutine.wrap(
        function()
            while wait() do
                CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(65, 105, 225)
                SlideCircle.ImageColor3 = Color3.fromRGB(65, 105, 225)
            end
        end
    )()
...
function tabcontent:Dropdown(text, list, callback)
    ...
    Dropdown.Parent = Tab
    Dropdown.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
    Dropdown.ClipsDescendants = true
    Dropdown.Position = UDim2.new(0, 0, 0, 0)
    Dropdown.Size = UDim2.new(0, 363, 0, 42)

    -- 胶囊型圆角：高度的一半
    DropdownCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    DropdownTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    DropItemHolder.BackgroundColor3 = Color3.fromRGB(230, 240, 255)  -- 浅蓝色背景
    DropItemHolder.BackgroundTransparency = 0
    DropItemHolder.BorderSizePixel = 0
    DropItemHolder.Position = UDim2.new(0.0358126722, 0, 1, 0)
    DropItemHolder.Size = UDim2.new(0, 342, 0, 0)
    DropItemHolder.CanvasSize = UDim2.new(0, 0, 0, 0)
    DropItemHolder.ScrollBarThickness = 3
    DropItemHolder.ScrollBarImageColor3 = Color3.fromRGB(135, 206, 235)  -- 按钮蓝色滚动条
    
    DropItemHolderCorner.CornerRadius = UDim.new(0, 6)  -- 添加圆角
    ...
    for i, v in next, list do
        ...
        Item.BackgroundColor3 = Color3.fromRGB(220, 230, 255)  -- 浅蓝色
        Item.ClipsDescendants = true
        Item.Size = UDim2.new(0, 335, 0, 25)
        Item.AutoButtonColor = false
        Item.Font = Enum.Font.Gotham
        Item.Text = v
        Item.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        Item.TextSize = 15.000

        -- 胶囊型圆角：高度的一半
        ItemCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
        ...
        Item.MouseEnter:Connect(
            function()
                TweenService:Create(
                    Item,
                    TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    {BackgroundColor3 = Color3.fromRGB(200, 220, 255)}  -- 悬停时更深的蓝色
                ):Play()
            end
        )
...
function tabcontent:Colorpicker(text, preset, callback)
    ...
    Colorpicker.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
    Colorpicker.ClipsDescendants = true
    Colorpicker.Position = UDim2.new(0, 0, 0, 0)
    Colorpicker.Size = UDim2.new(0, 363, 0, 42)

    -- 胶囊型圆角：高度的一半
    ColorpickerCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    ColorpickerTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ColorpickerTitle.TextSize = 14.000
    ColorpickerTitle.TextXAlignment = Enum.TextXAlignment.Left

    BoxColor.Name = "BoxColor"
    BoxColor.Parent = ColorpickerTitle
    BoxColor.BackgroundColor3 = preset or PresetColor  -- 使用预设或传入的颜色
    BoxColor.Position = UDim2.new(1.60427809, 0, 0.214285716, 0)
    BoxColor.Size = UDim2.new(0, 41, 0, 23)

    -- 胶囊型圆角：高度的一半
    BoxColorCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    ConfirmBtn.BackgroundColor3 = ButtonColor  -- 按钮蓝色
    ...
    -- 胶囊型圆角：高度的一半
    ConfirmBtnCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    ConfirmBtnTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    RainbowToggle.BackgroundColor3 = ButtonColor  -- 按钮蓝色
    ...
    -- 胶囊型圆角：高度的一半
    RainbowToggleCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
    ...
    RainbowToggleTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
    ...
    FrameRainbowToggle1.BackgroundColor3 = Color3.fromRGB(100, 149, 237)  -- 中蓝色
    FrameRainbowToggle1.Position = UDim2.new(0.649999976, 0, 0.186000004, 0)
    FrameRainbowToggle1.Size = UDim2.new(0, 37, 0, 18)

    FrameRainbowToggle1Corner.CornerRadius = UDim.new(1, 0)  -- 圆形
    ...
    FrameRainbowToggle3.BackgroundColor3 = Color3.fromRGB(176, 224, 230)  -- 更浅的蓝色
    FrameRainbowToggle3.BackgroundTransparency = 1.000
    FrameRainbowToggle3.Size = UDim2.new(0, 37, 0, 18)

    FrameToggle3.CornerRadius = UDim.new(1, 0)  -- 圆形
    FrameToggle3.Name = "FrameToggle3"
    ...
    FrameRainbowToggleCircle.BackgroundColor3 = Color3.fromRGB(240, 248, 255)  -- 淡蓝色
    FrameRainbowToggleCircle.Position = UDim2.new(0.127000004, 0, 0.222000003, 0)
    FrameRainbowToggleCircle.Size = UDim2.new(0, 10, 0, 10)

    FrameRainbowToggleCircleCorner.CornerRadius = UDim.new(1, 0)  -- 圆形
    ...
    pcall(callback, BoxColor.BackgroundColor3)
        ...
        function tabcontent:Label(text)
            ...
            Label.Name = "Label"
            Label.Parent = Tab
            Label.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
            ...
            -- 胶囊型圆角：高度的一半
            LabelCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
            ...
            LabelTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            Textbox.Parent = Tab
            Textbox.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
            Textbox.ClipsDescendants = true
            Textbox.Position = UDim2.new(0, 0, 0, 0)
            Textbox.Size = UDim2.new(0, 363, 0, 42)

            -- 胶囊型圆角：高度的一半
            TextboxCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
            ...
            TextboxTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
            ...
            TextboxFrame.BackgroundColor3 = Color3.fromRGB(240, 248, 255)  -- 淡蓝色
            TextboxFrame.Position = UDim2.new(1.28877008, 0, 0.214285716, 0)
            TextboxFrame.Size = UDim2.new(0, 100, 0, 23)

            -- 胶囊型圆角：高度的一半
            TextboxFrameCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
            ...
            TextBox.Text = ""
            TextBox.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.Name = "Bind"
            Bind.Parent = Tab
            Bind.BackgroundColor3 = ButtonColor  -- 使用按钮蓝色
            ...
            -- 胶囊型圆角：高度的一半
            BindCorner.CornerRadius = UDim.new(1, 0)  -- 圆形，实现胶囊型
            ...
            BindTitle.Text = text
            BindTitle.TextColor3 = Color3.fromRGB(25, 25, 112)  -- 深蓝色文字
            ...
            BindText.Text = Key
            BindText.TextColor3 = Color3.fromRGB(70, 130, 180)  -- 钢蓝色文字
