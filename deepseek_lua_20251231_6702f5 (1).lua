...
function applyNeonTextEffect(textLabel)
    ...
    -- 创建无限循环的偏移动画
    local offsetTween = ts:Create(gradient, ti, {Offset = Vector2.new(1, 0)})
    offsetTween:Play()
...
-- 设置颜色
local tabBarColor = Color3.fromRGB(255, 80, 160)       -- 标签栏颜色
local functionButtonColor = Color3.fromRGB(255, 200, 220) -- 功能按钮颜色

if theme == 'dark' then
    MainColor = Color3.fromRGB(0,0,0)
    Background = Color3.fromRGB(0,0,0)
    zyColor= functionButtonColor  -- 功能按钮使用新颜色
...
function toggleUIVisibility()
    ...
    if uiVisible then
        ...
        -- 缩小尺寸：从572x353缩小到500x300
        Tween(Main, {0.3, 'Quart', 'Out'}, {
            Size = UDim2.new(0, 500, 0, 300), -- 缩小尺寸
            Transparency = 0.0
        })
...
TabMain.Position = UDim2.new(0.217000037, 0, 0.01, 3) -- 增加Y位置以留出分界线空间
TabMain.Size = UDim2.new(0, 376, 0, 290) -- 稍微减少高度
TabMain.Transparency = 1.0

-- 在TabMain顶部添加功能页面分界线
local functionPageDivider = Instance.new("Frame")
functionPageDivider.Name = "FunctionPageDivider"
functionPageDivider.Parent = TabMain
functionPageDivider.BackgroundColor3 = tabBarColor
functionPageDivider.BorderSizePixel = 0
functionPageDivider.Size = UDim2.new(1, 0, 0, 2)
functionPageDivider.Position = UDim2.new(0, 0, 0, 0) -- 在 TabMain 顶部
...
-- 设置标签栏颜色
SideG.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, tabBarColor), ColorSequenceKeypoint.new(1.00, tabBarColor)}
SideG.Rotation = 90
SideG.Name = "SideG"
SideG.Parent = Side
...
tabBarDivider.Parent = Side
tabBarDivider.BackgroundColor3 = tabBarColor
tabBarDivider.BorderSizePixel = 0
tabBarDivider.Size = UDim2.new(1, 0, 0, 2)
tabBarDivider.Position = UDim2.new(0, 0, 0.08, 0) -- 在标题下方
...
TabBtns.Position = UDim2.new(0, 0, 0.1, 0) -- 从 0.097 调整到 0.1，避免重叠
...
FrameCorner.CornerRadius = UDim.new(0, 15) -- 圆角柜型，增加圆角
...
OpenCorner.CornerRadius = UDim.new(0, 15) -- 圆角柜型，增加圆角
...
function window.Tab(window, name, icon)
    ...
    function tab.section(tab, name, TabVal)
        ...
        -- 功能区保持圆角柜型
        SectionC.CornerRadius = UDim.new(0, 15) -- 圆角柜型，增加圆角
        ...
        SectionText.Size = UDim2.new(0, 336, 0, 36) -- 调整宽度
        ...
        function section.Button(section, text, callback)
            ...
            BtnModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            BtnModule.Transparency = 0.75
            
            Btn.Name = "Btn"
            Btn.Parent = BtnModule
            Btn.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            Btn.BorderSizePixel = 0
            Btn.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- 功能按钮保持胶囊型（椭圆）
            BtnC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            BtnC.Name = "BtnC"
            BtnC.Parent = Btn
        ...
        function section:Label(text)
            ...
            LabelModule.Size = UDim2.new(0, 364, 0, 22) -- 缩小宽度
            TextLabel.Parent = LabelModule
            TextLabel.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            TextLabel.Size = UDim2.new(0, 364, 0, 22) -- 缩小宽度
            ...
            -- 标签保持胶囊型
            LabelC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            LabelC.Name = "LabelC"
        ...
        function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            
            ToggleBtn.Name = "ToggleBtn"
            ToggleBtn.Parent = ToggleModule
            ToggleBtn.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            ToggleBtn.BackgroundTransparency = ALTransparency
            ToggleBtn.BorderSizePixel = 0
            ToggleBtn.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- Toggle按钮保持胶囊型
            ToggleBtnC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- 切换开关保持胶囊型
            ToggleSwitchC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ToggleSwitchC.Name = "ToggleSwitchC"
            ToggleSwitchC.Parent = ToggleSwitch
            
            -- 禁用框保持胶囊型
            ToggleDisableC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
        ...
        function section.Keybind(section, text, default, callback)
            ...
            KeybindModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            
            KeybindBtn.Name = "KeybindBtn"
            KeybindBtn.Parent = KeybindModule
            KeybindBtn.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            KeybindBtn.BorderSizePixel = 0
            KeybindBtn.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- 应用霓虹灯效果到按键绑定按钮文字（红黄混合）
            applyNeonTextEffect(KeybindBtn)
            
            -- Keybind按钮保持胶囊型
            KeybindBtnC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- Keybind值保持胶囊型
            KeybindValueC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
        ...
        function section.Textbox(section, text, flag, default, callback)
            ...
            TextboxModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            
            TextboxBack.Name = "TextboxBack"
            TextboxBack.Parent = TextboxModule
            TextboxBack.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            TextboxBack.BackgroundTransparency = ALTransparency
            TextboxBack.BorderSizePixel = 0
            TextboxBack.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- 应用霓虹灯效果到文本框标题文字（红黄混合）
            applyNeonTextEffect(TextboxBack)
            
            -- Textbox按钮保持胶囊型
            TextboxBackC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- 输入框背景保持胶囊型
            BoxBGC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            BoxBGC.Name = "BoxBGC"
            BoxBGC.Parent = BoxBG
        ...
        function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            
            SliderBack.Name = "SliderBack"
            SliderBack.Parent = SliderModule
            SliderBack.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            SliderBack.BackgroundTransparency = ALTransparency
            SliderBack.BorderSizePixel = 0
            SliderBack.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- Slider按钮保持胶囊型
            SliderBackC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- 滑块条保持胶囊型
            SliderBarC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- 滑块部分保持胶囊型
            SliderPartC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            -- 滑块值背景保持胶囊型
            SliderValBGC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
        ...
        function section.Dropdown(section, text, flag, options, callback)
            ...
            DropdownModule.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            
            DropdownTop.Name = "DropdownTop"
            DropdownTop.Parent = DropdownModule
            DropdownTop.BackgroundColor3 = functionButtonColor  -- 使用新颜色
            DropdownTop.BackgroundTransparency = ALTransparency
            DropdownTop.BorderSizePixel = 0
            DropdownTop.Size = UDim2.new(0, 364, 0, 38) -- 缩小宽度
            ...
            -- Dropdown按钮保持胶囊型
            DropdownTopC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
            ...
            local ToggleDropVis = function()
                ...
                Tween(DropdownModule, {0.3, 'Quart', 'Out'}, {
                    Size = UDim2.new(0, 364, 0, (open and DropdownModuleL.AbsoluteContentSize.Y + 4 or 38)) -- 缩小宽度
                })
            end
            ...
            DropdownModuleL:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
                if not open then return end
                DropdownModule.Size = UDim2.new(0, 364, 0, (DropdownModuleL.AbsoluteContentSize.Y + 4)) -- 缩小宽度
            end)
            ...
            funcs.AddOption = function(self, option)
                ...
                Option.BackgroundColor3 = functionButtonColor  -- 使用新颜色
                Option.BorderSizePixel = 0
                Option.Position = UDim2.new(0, 0, 0.328125, 0)
                Option.Size = UDim2.new(0, 364, 0, 26) -- 缩小宽度
                ...
                -- 选项保持胶囊型
                OptionC.CornerRadius = UDim.new(1, 0) -- 胶囊型（高度的一半）
