...
-- 优化版的Tween函数，避免过度创建tween
local activeTweens = {}
function Tween(obj, t, data)
    -- 如果已经有相同对象的tween，先停止它
...
local rippleCache = {}
function Ripple(obj)
    if not obj:IsDescendantOf(game) then return end
    ...
    spawn(function()
        ...
        -- 尝试从缓存中获取ripple
        local Ripple = table.remove(rippleCache)
        if not Ripple then
        ...
        wait(.3)
        Ripple.Parent = nil
        table.insert(rippleCache, Ripple) -- 回收到缓存
    end)
end
...
function switchTab(new)
  ...
  -- Slide out old tab
  if old[2] then
    Tween(old[2], {0.2, 'Quad', 'Out'}, {Position = UDim2.new(1, 0, 0, 0)})
  end
  ...
  Tween(new[2], {0.2, 'Quad', 'Out'}, {Position = UDim2.new(0, 0, 0, 0)})
...
function drag(frame, hold)
    ...
    -- 清理之前的连接
    if dragConnections[frame] then
        for _, conn in pairs(dragConnections[frame]) do
            conn:Disconnect()
        end
    end
    dragConnections[frame] = {}
    ...
    table.insert(dragConnections[frame], hold.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 then
            dragging = true
            dragStart = input.Position
            startPos = frame.Position

            table.insert(dragConnections[frame], input.Changed:Connect(function()
    ...
    table.insert(dragConnections[frame], frame.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement then
            dragInput = input
        end
    end))

    table.insert(dragConnections[frame], services.UserInputService.InputChanged:Connect(function(input)
...
function smoothScroll(frame, speed)
    ...
    -- 存储连接以便清理
    if not dragConnections[frame] then
        dragConnections[frame] = {}
    end
    table.insert(dragConnections[frame], connection)
end
...
-- 紫色和蓝色渐变颜色
local purpleColor = Color3.fromRGB(138, 43, 226)  -- 紫色
local blueColor = Color3.fromRGB(30, 144, 255)    -- 蓝色

-- 胶囊型按钮背景渐变
local buttonGradientColors = {
    ColorSequenceKeypoint.new(0.00, purpleColor),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(106, 90, 205)), -- 中间色
    ColorSequenceKeypoint.new(1.00, blueColor)
}

ALTransparency = 0.2  -- 按钮背景透明度
-------------------------AL------------------------------
if theme == 'dark' then
    MainColor = Color3.fromRGB(30, 30, 30)
    Background = Color3.fromRGB(25, 25, 25)
    zyColor = Color3.fromRGB(35, 35, 35)
    ...
    beijingColor = Color3.fromRGB(40, 40, 40)
      ...
      function UiDestroy()
          -- 清理所有连接
          for _, connections in pairs(dragConnections) do
      ...
      ctrlConnection = services.UserInputService.InputEnded:Connect(function(input)
      ...
      -- 存储连接
      if not dragConnections[Main] then dragConnections[Main] = {} end
      table.insert(dragConnections[Main], ctrlConnection)
      ...
      DropShadow.Image = "rbxassetid://123793012232435"  -- 背景图片
      ...
      local function titleAnimation()
          local gradient = ScriptTitle.UIGradient
          if not gradient then return end
          
          gradient.Color = ColorSequence.new{
              ColorSequenceKeypoint.new(0.00, purpleColor),
              ColorSequenceKeypoint.new(0.50, blueColor),
              ColorSequenceKeypoint.new(1.00, purpleColor)
          }
          ...
          spawn(function()
              while ScriptTitle and ScriptTitle.Parent do
                  ...
                  Tween(gradient, {2, 'Linear', 'InOut'}, {Offset = Vector2.new(1, 0)})
                  wait(2)
              end
          end)
      end
      spawn(titleAnimation)
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://70469295824259"  -- 隐藏UI按钮图片
Open.MouseButton1Click:Connect(function()
  ...
  local clickedSize = UDim2.new(0, 45, 0, 45)
  
  Tween(Open, {0.08, 'Quad', 'Out'}, {Size = clickedSize})
  wait(0.08)
  Tween(Open, {0.08, 'Quad', 'Out'}, {Size = originalSize})
end)
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        TabBtn.MouseEnter:Connect(function()
            Tween(TabIco, {0.15, 'Quad', 'Out'}, {
                ImageTransparency = 0
            })
            Tween(TabText, {0.15, 'Quad', 'Out'}, {
                TextTransparency = 0
            })
        end)
        ...
        function tab.section(tab, name, TabVal)
          ...
          SectionToggle.MouseButton1Click:Connect(function()
            ...
            Tween(SectionOpened, {0.15, 'Quad', 'Out'}, {
                ImageTransparency = (open and 0 or 1)
            })
            Tween(SectionOpen, {0.15, 'Quad', 'Out'}, {
          ...
          function section.Button(section, text, callback)
            ...
            local BtnGradient = Instance.new("UIGradient")  -- 添加渐变效果
            ...
            Btn.BackgroundColor3 = purpleColor  -- 默认紫色
            ...
            BtnC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
            BtnC.Name = "BtnC"
            BtnC.Parent = Btn
            
            -- 添加紫色到蓝色渐变
            BtnGradient.Color = ColorSequence.new(buttonGradientColors)
            ...
            Btn.MouseEnter:Connect(function()
                Tween(Btn, {0.15, 'Quad', 'Out'}, {
                    BackgroundTransparency = ALTransparency - 0.15
                })
            end)
        ...
        function section:Label(text)
          ...
          local LabelGradient = Instance.new("UIGradient")  -- 添加渐变效果
          ...
          TextLabel.BackgroundColor3 = purpleColor
          ...
          LabelC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
          LabelC.Name = "LabelC"
          LabelC.Parent = TextLabel
          
          -- 添加紫色到蓝色渐变
          LabelGradient.Color = ColorSequence.new(buttonGradientColors)
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            local ToggleGradient = Instance.new("UIGradient")  -- 添加渐变效果
            ...
            ToggleBtn.BackgroundColor3 = purpleColor
            ...
            ToggleBtnC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
            ToggleBtnC.Name = "ToggleBtnC"
            ToggleBtnC.Parent = ToggleBtn
            
            -- 添加紫色到蓝色渐变
            ToggleGradient.Color = ColorSequence.new(buttonGradientColors)
            ...
            local funcs = {
              SetState = function(self, state)
                ...
                services.TweenService:Create(ToggleSwitch, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    Position = UDim2.new(0, (state and ToggleSwitch.Size.X.Offset / 2 or 0), 0, 0), 
                    BackgroundColor3 = (state and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255,255,255))
                }):Play()
  ...
  local KeybindGradient = Instance.new("UIGradient")  -- 添加渐变效果
  ...
  KeybindBtn.BackgroundColor3 = purpleColor
  ...
  KeybindBtn.TextColor3 = FunctionFontColor
  KeybindBtn.TextSize = 16.000
  KeybindBtn.TextXAlignment = Enum.TextXAlignment.Left
  
  KeybindBtnC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
  KeybindBtnC.Name = "KeybindBtnC"
  KeybindBtnC.Parent = KeybindBtn
  
  -- 添加紫色到蓝色渐变
  KeybindGradient.Color = ColorSequence.new(buttonGradientColors)
  ...
  KeybindBtn.MouseEnter:Connect(function()
      Tween(KeybindBtn, {0.15, 'Quad', 'Out'}, {
          BackgroundTransparency = ALTransparency - 0.15
      })
  end)
  ...
  KeybindValue.MouseEnter:Connect(function()
      Tween(KeybindValue, {0.15, 'Quad', 'Out'}, {
...
function section.Textbox(section, text, flag, default, callback)
  ...
  local TextboxGradient = Instance.new("UIGradient")  -- 添加渐变效果
  ...
  TextboxBack.BackgroundColor3 = purpleColor
  ...
  TextboxBack.TextColor3 = FunctionFontColor
  TextboxBack.TextSize = 16.000
  TextboxBack.TextXAlignment = Enum.TextXAlignment.Left
  
  TextboxBackC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
  TextboxBackC.Name = "TextboxBackC"
  TextboxBackC.Parent = TextboxBack
  
  -- 添加紫色到蓝色渐变
  TextboxGradient.Color = ColorSequence.new(buttonGradientColors)
  ...
  BoxBG.Position = UDim2.new(0.75, 0, 0.2, 0)
  ...
  TextboxBack.MouseEnter:Connect(function()
      Tween(TextboxBack, {0.15, 'Quad', 'Out'}, {
          BackgroundTransparency = ALTransparency - 0.15
      })
  end)
  ...
  BoxBG.Size = UDim2.new(0, TextBox.TextBounds.X + 30, 0, 28)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            local SliderGradient = Instance.new("UIGradient")  -- 添加渐变效果
            ...
            SliderBack.BackgroundColor3 = purpleColor
            ...
            SliderBack.TextColor3 = FunctionFontColor
            SliderBack.TextSize = 16.000
            SliderBack.TextXAlignment = Enum.TextXAlignment.Left
            
            SliderBackC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
            SliderBackC.Name = "SliderBackC"
            SliderBackC.Parent = SliderBack
            
            -- 添加紫色到蓝色渐变
            SliderGradient.Color = ColorSequence.new(buttonGradientColors)
            ...
            SliderPart.BackgroundColor3 = purpleColor  -- 使用紫色
            SliderPart.BorderSizePixel = 0
            SliderPart.Size = UDim2.new(0, 54, 0, 13)
            SliderPart.ZIndex = 11
            ...
            MinSlider.Position = UDim2.new(0.25, 0, 0.2, 0)
            MinSlider.Size = UDim2.new(0, 20, 0, 20)
            MinSlider.Font = Enum.Font.Gotham
            MinSlider.Text = "-"
            MinSlider.TextColor3 = FunctionFontColor
            ...
            AddSlider.Position = UDim2.new(0.73, 0, 0.5, 0)
            AddSlider.Size = UDim2.new(0, 20, 0, 20)
            AddSlider.Font = Enum.Font.Gotham
            AddSlider.Text = "+"
            AddSlider.TextColor3 = FunctionFontColor
            ...
            local funcs = {
              SetValue = function(self, value)
                ...
                Tween(SliderPart, {0.15, 'Quad', 'Out'}, {
            ...
            SliderBack.MouseEnter:Connect(function()
                Tween(SliderBack, {0.15, 'Quad', 'Out'}, {
                    BackgroundTransparency = ALTransparency - 0.15
                })
            end)
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            local DropdownGradient = Instance.new("UIGradient")  -- 添加渐变效果
            ...
            DropdownTop.BackgroundColor3 = purpleColor
            ...
            DropdownTop.Text = ""
            DropdownTop.TextColor3 = FunctionFontColor
            DropdownTop.TextSize = 16.000
            DropdownTop.TextXAlignment = Enum.TextXAlignment.Left
            
            DropdownTopC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
            DropdownTopC.Name = "DropdownTopC"
            DropdownTopC.Parent = DropdownTop
            
            -- 添加紫色到蓝色渐变
            DropdownGradient.Color = ColorSequence.new(buttonGradientColors)
            ...
            DropdownOpen.Text = "+"
            DropdownOpen.TextColor3 = FunctionFontColor
            DropdownOpen.TextSize = 24.000
            DropdownOpen.TextWrapped = true
            DropdownOpen.ZIndex = 10
            ...
            DropdownText.PlaceholderColor3 = FunctionFontColor
            DropdownText.PlaceholderText = text
            DropdownText.Text = ""
            DropdownText.TextColor3 = FunctionFontColor
            DropdownText.TextSize = 16.000
            DropdownText.TextXAlignment = Enum.TextXAlignment.Left
            DropdownText.ZIndex = 10
            ...
            DropdownTop.MouseEnter:Connect(function()
                Tween(DropdownTop, {0.15, 'Quad', 'Out'}, {
                    BackgroundTransparency = ALTransparency - 0.15
                })
            end)
            ...
            funcs.AddOption = function(self, option)
              local Option = Instance.new("TextButton")
              local OptionC = Instance.new("UICorner")     
              local OptionGradient = Instance.new("UIGradient")  -- 添加渐变效果
    
              Option.Name = "Option_" .. option
              Option.Parent = DropdownModule
              Option.BackgroundColor3 = purpleColor
              ...
              Option.Text = option
              Option.TextColor3 = FunctionFontColor
              Option.TextSize = 14.000
              Option.ZIndex = 10
              
              OptionC.CornerRadius = UDim.new(0, 18)  -- 胶囊型圆角
              OptionC.Name = "OptionC"
              OptionC.Parent = Option
              
              -- 添加紫色到蓝色渐变
              OptionGradient.Color = ColorSequence.new(buttonGradientColors)
