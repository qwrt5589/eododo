...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function tab.section(tab, name, TabVal)
          ...
          function section.Button(section, text, callback)
            ...
            BtnImage.ScaleType = Enum.ScaleType.Slice
            BtnImage.SliceCenter = Rect.new(100, 100, 100, 100)
            BtnImage.ImageTransparency = 0.7
        ...
        function section:Label(text)
          ...
          LabelImage.ScaleType = Enum.ScaleType.Slice
          LabelImage.SliceCenter = Rect.new(100, 100, 100, 100)
          LabelImage.ImageTransparency = 0.7
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleImage.ImageTransparency = 0.7
  ...
  KeybindImage.ScaleType = Enum.ScaleType.Slice
  KeybindImage.SliceCenter = Rect.new(100, 100, 100, 100)
  KeybindImage.ImageTransparency = 0.7
...
function section.Textbox(section, text, flag, default, callback)
  ...
  TextboxImage.ScaleType = Enum.ScaleType.Slice
  TextboxImage.SliceCenter = Rect.new(100, 100, 100, 100)
  TextboxImage.ImageTransparency = 0.7
  ...
  BoxBG.Size = UDim2.new(0, TextBox.TextBounds.X + 30, 0, 28)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderImage.ImageTransparency = 0.7
          ...
          function section.Dropdown(section, text, flag, options, callback)
            ...
            DropdownTop.Text = ""
            DropdownTop.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（粉红色）
            ...
            DropdownImage.ScaleType = Enum.ScaleType.Slice
            DropdownImage.SliceCenter = Rect.new(100, 100, 100, 100)
            DropdownImage.ImageTransparency = 0.7
            ...
            DropdownOpen.Text = "+"
            DropdownOpen.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（粉红色）
            ...
            DropdownText.PlaceholderColor3 = FunctionFontColor  -- 使用功能页面字体颜色（粉红色）
            DropdownText.PlaceholderText = text
            DropdownText.Text = ""
            DropdownText.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（粉红色）
            ...
            funcs.AddOption = function(self, option)
              ...
              Option.Text = option
              Option.TextColor3 = FunctionFontColor  -- 使用功能页面字体颜色（粉红色）
              ...
              OptionImage.ScaleType = Enum.ScaleType.Slice
              OptionImage.SliceCenter = Rect.new(100, 100, 100, 100)
              OptionImage.ImageTransparency = 0.7
