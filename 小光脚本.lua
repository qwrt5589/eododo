...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://132687438136833" --背景
...
tool:Button("强制第三人称", function()
    ...
    local function updateThirdPersonCamera()
        ...
        local cameraCFrame = humanoidRootPart.CFrame * CFrame.new(offset)
    ...
    cameraConnection = RunService.RenderStepped:Connect(updateThirdPersonCamera)
    
    print("已启用强制第三人称模式")
    
    -- 可选：添加关闭功能
    tool:Button("恢复第一人称", function()
