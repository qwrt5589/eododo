...
-- 颜色定义
local backgroundColor = Color3.fromRGB(50, 50, 80)      -- 深蓝色背景
local buttonColor = Color3.fromRGB(70, 70, 120)         -- 按钮蓝色
local accentColor = Color3.fromRGB(90, 90, 160)         -- 强调蓝色
local textColor = Color3.fromRGB(255, 255, 255)         -- 白色文字
...
closebutton.BackgroundColor3 = Color3.fromRGB(120, 40, 40)  -- 暗红色
...
onof.MouseButton1Down:connect(function() 
    if nowe == true then 
        ...
        nowe = true 
        onof.Text = "停止"  -- 更新按钮文本
        onof.BackgroundColor3 = Color3.fromRGB(120, 40, 40)  -- 变为红色表示激活
