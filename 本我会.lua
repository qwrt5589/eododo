...
function library.new(library, name, theme)
    ...
    Main.Size = UDim2.new(0, 542, 0, 333)  -- 缩小UI面板
    Main.ZIndex = 1
    Main.Active = true
    Main.Draggable = true
    ...
    UICornerMain.CornerRadius = UDim.new(0, 12)  -- 改为圆角
    ...
    TabMain.Size = UDim2.new(0, 418, 0, 333)  -- 调整大小

    MainC.CornerRadius = UDim.new(0, 12)  -- 改为圆角
    MainC.Name = "MainC"
    MainC.Parent = TabMain  -- 修正为TabMain

    SB.Name = "SB"
    SB.Parent = Main
    SB.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    SB.BorderColor3 = MainColor
    SB.Position = UDim2.new(0, 0, 0.5, 0)  -- 居中
...
Open.Size = UDim2.new(0, 48, 0, 48)  -- 改为正方形
Open.Font = Enum.Font.SourceSans
Open.Text = ""
Open.TextColor3 = Color3.fromRGB(255, 255, 255)
Open.TextTransparency = 1  -- 隐藏文字
Open.TextSize = 14.000
Open.Active = true
Open.Draggable = true

OpenCorner.CornerRadius = UDim.new(0, 12)  -- 圆角
...
OpenIcon.Image = "rbxassetid://130119786616496"  -- 打开时显示的图片
OpenIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)

Open.MouseButton1Click:Connect(function()
    Main.Visible = not Main.Visible
    if Main.Visible then
        OpenIcon.Image = "rbxassetid://130119786616496"  -- 面板打开时
    else
        OpenIcon.Image = "rbxassetid://79285958044576"  -- 面板关闭时
    end
end)
    ...
    function window.Tab(window, name, icon)
        ...
        TabL.Padding = UDim.new(0, 8)  -- 增加间距
        ...
        function tab.section(tab, name, TabVal)
            ...
            SectionC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
            ...
            function section.Button(section, text, callback)
                ...
                BtnC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
                BtnC.Name = "BtnC"
                BtnC.Parent = Btn
            ...
            function section:Label(text)
                ...
                LabelC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
                LabelC.Name = "LabelC"
            ...
            function section.Toggle(section, text, flag, enabled, callback)
                ...
                ToggleBtnC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
                ...
                ToggleSwitchC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
                ToggleSwitchC.Name = "ToggleSwitchC"
                ToggleSwitchC.Parent = ToggleSwitch

                ToggleDisableC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
    ...
    KeybindBtnC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
    ...
    KeybindValueC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
...
function section.Textbox(section, text, flag, default, callback)
    ...
    TextboxBackC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
    ...
    BoxBGC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
    BoxBGC.Name = "BoxBGC"
    BoxBGC.Parent = BoxBG
...
function section.Slider(section, text, flag, default, min, max, precise, callback)
    ...
    SliderBackC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
    ...
    SliderBarC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
    ...
    SliderPartC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
    ...
    SliderValBGC.CornerRadius = UDim.new(0, 12)  -- 增加圆角
    ...
    services.UserInputService.InputEnded:Connect(
        function(input)
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownTopC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
                ...
                funcs.AddOption = function(self, option)
                    ...
                    OptionC.CornerRadius = UDim.new(1, 0)  -- 胶囊形状
