...
function applyNeonTextEffect(textLabel)
    ...
    local colorSequence = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(0.14, neonColors[2]),
        ColorSequenceKeypoint.new(0.28, neonColors[3]),
        ColorSequenceKeypoint.new(0.42, neonColors[4]),
        ColorSequenceKeypoint.new(0.56, neonColors[5]),
        ColorSequenceKeypoint.new(0.70, neonColors[6]),
        ColorSequenceKeypoint.new(0.84, neonColors[7]),
        ColorSequenceKeypoint.new(1, neonColors[8])
    })
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(20, 20, 20)
      ...
      UICornerMain.CornerRadius = UDim.new(0, 15) -- 圆角柜型
      ...
      -- 圆角柜型：增大圆角
      SBC.CornerRadius = UDim.new(0, 10) -- 圆角柜型
      SBC.Name = "SBC"
      SBC.Parent = SB
...
FrameCorner.CornerRadius = UDim.new(0, 10) -- 圆角柜型
...
OpenCorner.CornerRadius = UDim.new(0, 10) -- 圆角柜型
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
          ...
          -- 功能区保持圆角柜型
          SectionC.CornerRadius = UDim.new(0, 10) -- 圆角柜型
