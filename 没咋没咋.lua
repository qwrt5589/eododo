...
function Library.new(theme, title, style)
    ...
    local ALcolor = Color3.fromRGB(255, 192, 203)
    ...
    coroutine.wrap(function()
        ...
        for i = 1, 10 do
            local hue = i * 17
            table.insert(colorPalette, Color3.fromHSV(hue / 255, 255 / 255, 255 / 255))
        end
    ...
    section = function(_, sectionName, isOpen)
        ...
        return {
            ...
            Textbox = function(_, textboxText, flag, defaultText, callback)
                ...
                BoxBackground.Text = ""
                BoxBackground.TextColor3 = Color3.fromRGB(255, 0, 0)
                ...
                TextboxInput.TextColor3 = Color3.fromRGB(255, 0, 0)
            ...
            Slider = function(_, sliderText, flag, defaultValue, minValue, maxValue, increment, callback)
                ...
                SliderValueBG.Text = ""
                SliderValueBG.TextColor3 = Color3.fromRGB(255, 0, 0)
...
Dropdown = function(_, dropdownText, flag, options, callback)
    ...
    DropdownTextInput.TextColor3 = Color3.fromRGB(255, 0, 0)
