...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://132967266932101" --背景
...
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://93335136969857" or "rbxassetid://88077878549018" --开关的图
end)
...
-- 在信息标题下面、你的注入器上面添加切换背景按钮
bin:Button("切换背景", function()
...
tool:Button("空云脚本",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaoSB33/M416/refs/heads/main/Wind%2Fsb%2F%E7%A9%BA%E4%BA%91%E8%84%9A%E6%9C%ACV2.LUA",true))()
end)
