...
function AnimateTextColor(textLabel)
    spawn(function()
        while textLabel and textLabel.Parent do
            ...
            local tweenInfo = TweenInfo.new(colorTransitionSpeed, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut)
            services.TweenService:Create(textLabel, tweenInfo, {TextColor3 = nextColor}):Play()
            task.wait(colorTransitionSpeed)
...
function ToggleUILib()
	...
	UICornerMain.CornerRadius = UDim.new(0, 15)  -- 增加圆角半径
	...
	MainC.CornerRadius = UDim.new(0, 10)  -- 增加圆角半径
	MainC.Name = "MainC"
	MainC.Parent = Main
...
-- 修改为正方形尺寸
Open.Size = UDim2.new(0, 50, 0, 50)  -- 正方形，尺寸相同
Open.Image = "rbxassetid://79285958044576"  -- 默认关闭状态图片
...
OpenCorner.CornerRadius = UDim.new(0, 15)  -- 圆角半径
...
Open.MouseButton1Click:Connect(function()
	...
	spawn(function()
		-- 缩小动画
		services.TweenService:Create(Open, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		-- 切换图片
		if isOpen then
			Open.Image = "rbxassetid://130119786616496"  -- 打开状态图片
			Main.Visible = true
		else
			Open.Image = "rbxassetid://79285958044576"  -- 关闭状态图片
			Main.Visible = false
		end
		...
		-- 轻微弹跳效果
		services.TweenService:Create(Open, TweenInfo.new(0.08, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
Open.MouseEnter:Connect(function()
	if isAnimating then return end
	services.TweenService:Create(Open, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
...
function window.Tab(window, name, icon)
	...
	function tab.section(tab, name, TabVal)
		...
		function section:Label(text)
			...
			LabelC.CornerRadius = UDim.new(0, 11)
			LabelC.Name = "LabelC"
		...
		function section.Toggle(section, text, flag, enabled, callback)
			...
			ToggleBtn.Text = "   " .. text
			ToggleBtn.TextColor3 = GetRainbowColor()
			ToggleBtn.TextSize = 16.000
			ToggleBtn.TextTransparency = 0
			ToggleBtn.TextXAlignment = Enum.TextXAlignment.Left
			
			ToggleBtnC.CornerRadius = UDim.new(0, 19)
			ToggleBtnC.Name = "ToggleBtnC"
			ToggleBtnC.Parent = ToggleBtn
			
			-- 开关文字霓虹灯动画
			AnimateTextColor(ToggleBtn)
		...
		function section.Keybind(section, text, default, callback)
			...
			KeybindBtn.TextColor3 = GetRainbowColor()
			KeybindBtn.TextSize = 16.000
			KeybindBtn.TextTransparency = 0
			KeybindBtn.TextXAlignment = Enum.TextXAlignment.Left
			
			KeybindBtnC.CornerRadius = UDim.new(0, 19)
			KeybindBtnC.Name = "KeybindBtnC"
			KeybindBtnC.Parent = KeybindBtn
			
			-- 按键绑定文字霓虹灯动画
			AnimateTextColor(KeybindBtn)
			...
			KeybindValue.TextColor3 = GetRainbowColor()
			KeybindValue.TextSize = 14.000
			KeybindValue.TextTransparency = 0
			
			KeybindValueC.CornerRadius = UDim.new(0, 14)
			KeybindValueC.Name = "KeybindValueC"
			KeybindValueC.Parent = KeybindValue
			
			-- 按键值文字霓虹灯动画
			AnimateTextColor(KeybindValue)
			...
			KeybindValue.Size = UDim2.new(0, KeybindValue.TextBounds.X + 30, 0, 28)
				...
				BoxBGC.CornerRadius = UDim.new(0, 14)
				BoxBGC.Name = "BoxBGC"
				BoxBGC.Parent = BoxBG
			...
			function section.Slider(section, text, flag, default, min, max, precise, callback)
				...
				SliderBack.TextColor3 = GetRainbowColor()
				SliderBack.TextSize = 16.000
				SliderBack.TextTransparency = 0
				SliderBack.TextXAlignment = Enum.TextXAlignment.Left
				
				SliderBackC.CornerRadius = UDim.new(0, 19)
				SliderBackC.Name = "SliderBackC"
				SliderBackC.Parent = SliderBack
				
				-- 滑块文字霓虹灯动画
				AnimateTextColor(SliderBack)
				...
				SliderValBGC.CornerRadius = UDim.new(0, 14)
				...
				SliderValue.TextColor3 = GetRainbowColor()
				SliderValue.TextSize = 14.000
				SliderValue.TextTransparency = 0
				
				-- 滑块值文字霓虹灯动画
				AnimateTextColor(SliderValue)
				...
				MinSlider.Text = "-"
				MinSlider.TextColor3 = GetRainbowColor()
				MinSlider.TextSize = 24.000
				MinSlider.TextTransparency = 0
				MinSlider.TextWrapped = true
				
				-- 减号按钮霓虹灯动画
				AnimateTextColor(MinSlider)
				...
				AddSlider.Text = "+"
				AddSlider.TextColor3 = GetRainbowColor()
				AddSlider.TextSize = 24.000
				AddSlider.TextTransparency = 0
				AddSlider.TextWrapped = true
				
				-- 加号按钮霓虹灯动画
				AnimateTextColor(AddSlider)
			...
			function section.Dropdown(section, text, flag, options, callback)
				...
				DropdownTopC.CornerRadius = UDim.new(0, 19)
				...
				DropdownOpen.Text = "+"
				DropdownOpen.TextColor3 = GetRainbowColor()
				DropdownOpen.TextSize = 24.000
				DropdownOpen.TextTransparency = 0
				DropdownOpen.TextWrapped = true
				
				-- 下拉展开按钮霓虹灯动画
				AnimateTextColor(DropdownOpen)
				...
				DropdownText.Text = ""
				DropdownText.TextColor3 = GetRainbowColor()
				DropdownText.TextSize = 16.000
				DropdownText.TextTransparency = 0
				DropdownText.TextXAlignment = Enum.TextXAlignment.Left
				
				-- 下拉文本框霓虹灯动画
				AnimateTextColor(DropdownText)
				...
				funcs.AddOption = function(self, option)
					...
					Option.Text = option
					Option.TextColor3 = GetRainbowColor()
					Option.TextSize = 14.000
					Option.TextTransparency = 0
					
					OptionC.CornerRadius = UDim.new(0, 13)
					OptionC.Name = "OptionC"
					OptionC.Parent = Option
					
					-- 选项文字霓虹灯动画
					AnimateTextColor(Option)
