...
-- 添加背景图片ID
local BackgroundImageId = "123793012232435"
...
function library.new(library, name, theme)
	...
	zyColorTransparency = 0.55                 -- 控件半透明
	...
	Open.Text = "天命人"
	Open.TextColor3 = Color3.fromRGB(255, 255, 255)  -- 初始白色
	Open.TextTransparency = 0
	Open.TextSize = 18.000  -- 增大字体大小
	Open.Active = true
	Open.Draggable = true
	Open.ZIndex = 100
	...
	UIG.Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 0)),      -- 红色
		ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 165, 0)),    -- 橙色
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 255, 0)),    -- 黄色
		ColorSequenceKeypoint.new(0.75, Color3.fromRGB(0, 255, 0)),      -- 绿色
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 255))       -- 蓝色
	})
	UIG.Rotation = 0
	
	-- 添加彩虹渐变动画到打开按钮
	local rainbowTween = TweenService:Create(UIG, TweenInfo.new(3, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), { Rotation = 360 })
	rainbowTween:Play()
