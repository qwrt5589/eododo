...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(20, 20, 20)
      ...
      UICornerMain.CornerRadius = UDim.new(0, 20) -- 增加圆角幅度
      ...
      -- 增大圆角
      SBC.CornerRadius = UDim.new(0, 12) -- 增大圆角
      SBC.Name = "SBC"
      SBC.Parent = SB
...
FrameCorner.CornerRadius = UDim.new(0, 12) -- 增大圆角
...
OpenCorner.CornerRadius = UDim.new(0, 12) -- 增大圆角
...
UIG.Parent = Open
      ...
      function window.Tab(window, name, icon)
        ...
        function tab.section(tab, name, TabVal)
          ...
          -- 增大功能区圆角
          SectionC.CornerRadius = UDim.new(0, 12) -- 增大圆角
...
function section.Textbox(section, text, flag, default, callback)
  ...
  BoxBG.Size = UDim2.new(0, TextBox.TextBounds.X + 30, 0, 28)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            -- 增大滑块条圆角
            SliderBarC.CornerRadius = UDim.new(0, 8) -- 增大圆角
            ...
            -- 增大滑块部分圆角
            SliderPartC.CornerRadius = UDim.new(0, 8) -- 增大圆角
            ...
            -- 增大滑块值背景圆角
            SliderValBGC.CornerRadius = UDim.new(0, 15) -- 增大圆角
