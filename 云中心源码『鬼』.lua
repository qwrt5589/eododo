...
print("用户界面库加载成功！")
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("光脚本中心☁️")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
local CNA = CNScript:section("小光制作", false)
...
LOL:Label("光脚本的创作者小光 QQ168777105")
LOL:Label("123fa98通过白名单来保护光脚本")
LOL:Label("后续会继续添加脚本，不会停更。由于找的外国脚本可能存在不兼容的问题，请见谅")
LOL:Label("光脚本非常易用且功能强大")
LOL:Label("光脚本正在经历疯狂优化，性能将更加强大")
LOL:Label("光脚本中心1群号526684389")
LOL:Label("光脚本中心2群号")
LOL:Button(
    "复制到光脚本①群号（如果找不到）",
    function()
...
AQ:Label("有没有收费其他脚本，请加小光QQ168777105")
...
local tab1 = library:CreateTab("  光脚本中心", true)
...
JABAJA:Toggle("光脚本中心","text",false,function(s)
...
-- 添加其他功能函数
Jan:Button("光脚本中心",function()
--[[
    光脚本 THIEF LIFE SIMULATOR SOURCE
...
print("[ 光脚本 ]: 光脚本 THIEF LIFE SIMULATOR LOADING...")
...
Game:addToggle("RTX着色器", false, function(rtxshaders)
    ...
    if rtxshaders == false then
        for i,v in pairs(game.Lighting:GetChildren()) do
            if v.Name == "[ 光脚本 ]: 日落" then
                v:Destroy()
            elseif v.Name == "[ 光脚本 ]: 花" then
                v:Destroy()
            elseif v.Name == "[ 光脚本 ]: 伊那里泰莎" then
                v:Destroy()
            elseif v.Name == "[ 光脚本 ]: 简单" then
                v:Destroy()
            elseif v.Name == "[ 光脚本 ]: 阳光" then
                v:Destroy()
            elseif v.Name == "[ 光脚本 ]: 高山" then
                v:Destroy()
            end
        end
        wait()
    ...
    while killpetloop do
        if playertarget == "All" then
            ...
            if game.workspace.Pets:FindFirstChild(playertarget .."_PET") ~= nil then
                ...
                Notification:Notify(
                    {Title = "光脚本", Description = "玩家没有装备宠物"},
                    {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "default"}
                )
                killpetloop = false
            end
...
JB_NOTIFICATIONS.new({
	Text = "光脚本中心已成功启动，尽情享受吧！",
	Duration = 2
})
end)
Java:Label("↑是不是BUG，有找小光")
...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("光脚本中心 V2.1.2")
----------------------------------------------------------------------------------------------------------------------------------------
